...
public:
	...
	double get_rows() const {return rows;} // Return number of rows
	double get_columns() const {return cols;} // Return number of columns
	bool check_dimensions_of_matrix(std::string, const int, const int);
